      ...
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex justify-center items-center py-8 lg:py-0 w-full">
            {/* Aspect Square keeps it perfectly round, while max-w controls the scaling */}
            <div className="relative w-full max-w-[280px] sm:max-w-[340px] md:max-w-[420px] aspect-square bg-zinc-900 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.8)] border-4 border-zinc-800 flex items-center justify-center mx-auto shrink-0">
              ...
              {/* Record Grooves (Percentage based to scale perfectly) */}
          ...
          <div className="space-y-6 md:space-y-8 lg:pl-10 relative z-10 text-center lg:text-left">
            ...
            <div className="prose prose-invert prose-base sm:prose-lg text-amber-200/80 font-sans leading-relaxed mx-auto lg:mx-0">
              <p>
                ...
                I am a Full-Stack Developer who treats code like a composition—layering robust backend architectures 
                with dynamic, responsive frontend melodies.
              </p>
              <p>
                Currently spinning tracks in the open-source world, I specialize in crafting digital experiences that 
        ...
        <div className="pt-16 border-t border-amber-900/30">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={index} className="bg-[#1a110a] p-6 sm:p-8 rounded-xl border border-amber-900/40 shadow-xl transition-transform hover:-translate-y-2">
          ...
          <div>
            ...
            <div className="space-y-4 font-sans">
              {[
                ...
                <div key={i} className="group flex items-center p-3 sm:p-4 bg-[#1a110a]/50 hover:bg-[#1a110a] border border-amber-900/20 hover:border-amber-500/50 rounded-lg transition-all">
                  ...
                  {/* Changed from <button> to <a> tag for external routing */}
                  <a 
                    href={track.repoUrl}
                    target="_blank"
          ...
          <div>
            ...
            <div className="relative border-l-2 border-amber-900/50 ml-3 sm:ml-4 space-y-8 pb-4">
              {[
                ...
                <div key={i} className="relative pl-6 sm:pl-8 font-sans">
